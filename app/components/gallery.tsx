      ...
      <div className="max-w-7xl mx-auto px-4 mt-14">
        ...
        <div className="flex justify-center items-center gap-2 mt-14">
          <button
            ...
            disabled={page === 1}
            className="px-4 py-2 text-sm font-poppins font-extrabold bg-[#638ECB] hover:bg-[#395886] text-white cursor-pointer rounded disabled:bg-gray-300 disabled:text-white disabled:cursor-not-allowed transition"
          >
            Previous
          </button>
