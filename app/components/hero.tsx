    ...
    >
      ...
      <div className="z-10 text-center flex gap-30 flex-col justify-center items-center">
        ...
        <h1 className="typingText">
          <span className="hidden">XII RPL 3</span>
          <span className="hidden">
            Profil Kelas RPL 3 Angkatan 23 SMKN 4 Kendal: struktur kelas,
            anggota, prestasi, dan galeri kegiatan.
          </span>
          <span className="hidden">RPL 3 - SKANIFO (Angkatan 23)"</span>
          <TypeAnimation
        ...
        <p className="text-white font-poppins font-semibold md:text-[20px]">
          Kelas Rekayasa Perangkat Lunak <br /> yang inovatif, dan Kreatif dalam
          Ide, Tangguh dalam Eksekusi
        </p>
